...
export const ComputerAccessories: React.FC = () => {
  ...
  // No need to fetch all subcategory products here; just slice for UI
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center ">
            ...
            <div className="flex w-[70%] overflow-x-auto items-center">
              <button
                className={`px-4 py-2 text-xs font-medium rounded-t ${activeTab === 0 ? 'border-b-2 border-orange-500' : 'hover:bg-yellow-50'
                  }`}
