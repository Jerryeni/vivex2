...
export const PromotionalBanners2: React.FC = () => {
  return (
    <div className="max-w-7xl bg-orange-100 mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="bg-transparent p-8 rounded-lg flex items-center">
        <div>
          <span className="text-blue-500 text-sm">SAVE UP TO $200.00</span>
